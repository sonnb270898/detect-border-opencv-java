...
import com.boxes.broadcast.UsbReceiver;
import com.boxes.callback.IDataCallback;
import com.boxes.handler.MyHandler;
...
public final class MainActivity extends BaseActivity implements CameraDialog.CameraDialogParent , IDataCallback ,View.OnClickListener{
...
//====================================== USB serial ===============================================
    ...
    public void initView(){
        ...
        objWidth = findViewById(R.id.obj_width);
        objHeight = findViewById(R.id.obj_height);
        objDepth = findViewById(R.id.obj_depth);
        ...
        objHeight.setOnClickListener(this);
        disconnectButton.setOnClickListener(this);
        // get Region of Interest

        selectRoiButton.setOnClickListener(this);
        if(widthImgView != 0){
...
//                    motionFlag = detectMotion(crop_startFrame, crop_gray_img, 100);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.obj_height:
                usbService.write("tien".getBytes());
                break;
